...
function validarCasillas(){
    validator = 0; //Evita que pueda presionar el boton 6 veces
    //Si la casilla no esta vacia la validamos con un 1
    if(document.getElementById("nombre").value != ""){validator = validator +1;};
    if(document.getElementById("apellido").value != ""){validator = validator +1;};
    if(document.getElementById("ciudad").value != ""){validator = validator +1;};
    if(document.getElementById("alimento").value != ""){validator = validator +1;};
    if(document.getElementById("animal").value != ""){validator = validator +1;};
    if(document.getElementById("cosa").value != ""){validator = validator +1;};
    
    if(validator >= 6){return true;}//Si todas las casillas han sido llenadas
    else{return false;}
}

function iniciar(evt){ //Este es el metodo que genera el error
